 ...
 */
final class Version20201128174430 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE booking_offer (id INT AUTO_INCREMENT NOT NULL, offer_type_id INT NOT NULL, destination_id INT NOT NULL, offer_name VARCHAR(255) NOT NULL, package_id INT NOT NULL, offer_price NUMERIC(6, 2) NOT NULL, booking_start_date DATETIME NOT NULL, booking_end_date DATETIME NOT NULL, departure_date DATETIME NOT NULL, comeback_date DATETIME NOT NULL, departure_spot VARCHAR(255) NOT NULL, comeback_spot VARCHAR(255) NOT NULL, is_featured TINYINT(1) NOT NULL, INDEX IDX_B8AA7A8B64444A9A (offer_type_id), INDEX IDX_B8AA7A8B816C6140 (destination_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, booking_offer_id INT NOT NULL, date_of_booking DATETIME NOT NULL, is_paid_for TINYINT(1) NOT NULL, bank_transfer_date DATETIME DEFAULT NULL, INDEX IDX_42C84955A76ED395 (user_id), INDEX IDX_42C8495568F2EA63 (booking_offer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, registration_date DATE NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE customers_rating ADD CONSTRAINT FK_93BE1206A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
